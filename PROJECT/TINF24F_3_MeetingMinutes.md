...
| Agenda       | Summary                                                 |
| ------------ | ------------------------------------------------------- |
| UC01, 02, 03 | Issue->BaSyx-Repo, Integration in Repo                  |
| UC04         | good problem analysis und theoretical solution by Felix |
| STP          | one unit test missing                                   |
| next steps   | user manual, MOD, presentation                          |
