...
| ------- | ---------- | ------------------------------------- | ------------- |
| 1.0     | 27.10.2025 | Leonardo Risatti and Felix Bandl | First version |


## Table of Contents

1. Introduction & Problem Statement
2. Filter Dimensions (Core Concepts)
3. REST Endpoints
4. Backend Architecture (UML Class Diagram)
5. Processing Flow (Backend Logic)

## API Specification: Selective Submodel Queries (M2M)
