...
| ------- | ---------- | ------------------------------------- | ------------- |
| 1.0     | 17.04.2026 | Leonardo Risatti and Felix Bandl | First version |
| 1.1      | 24.04.2026 |  Felix Bandl | Structure Document and not Implemented |
| 1.2      | 08.05.2026 |  Felix Bandl | Update Classdiagramm |
## Table of Contents
...
classDiagram
    ...
    SubmodelQueryService --> SubmodelElement : searches & filters
     SubmodelElement "1" *-- "*" SubmodelElement : contains as sub-elements
```
